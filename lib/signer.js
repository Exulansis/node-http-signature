 ...
 */
RequestSigner.prototype.writeHeader = function (header, value, addToRequestObject) {
  ...
  if (addToRequestObject) {
    addToRequestObject(header, value)
  }
 ...
 */
RequestSigner.prototype.sign = function (cb, options) {
